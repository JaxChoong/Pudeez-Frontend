...
export default function BidItemDetailsPage() {
  ...
  const item = {
    ...
    status: "auction", // change this to "sale" to toggle
    currentBid: "0.04 SUI",
    minBidIncrement: "0.01 SUI",
    endsIn: "2h 15m",
  };
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300">{item.description}</p>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  <label className="text-gray-400 block mb-1">Enter Your Bid</label>
                  <input
                    type="text"
                    value={bidAmount}
                    onChange={(e) => setBidAmount(e.target.value)}
                    placeholder={`Min +${item.minBidIncrement}`}
